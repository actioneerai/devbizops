      ...
      <div className={`bg-indigo-800 text-white ${isSidebarOpen ? 'w-64' : 'w-20'} transition-all duration-300 ease-in-out`}>
        ...
        <nav className="mt-6">
          <div className="px-4 py-2">
            <Link 
              to={isDemoMode ? "/demo/dashboard" : "/dashboard"} 
              className="flex items-center py-2 px-4 text-white hover:bg-indigo-700 rounded-md transition-colors"
            >
            ...
            <Link 
              to={isDemoMode ? "/demo/ai-agents" : "/ai-agents"} 
              className="flex items-center py-2 px-4 text-white hover:bg-indigo-700 rounded-md transition-colors mt-2"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
